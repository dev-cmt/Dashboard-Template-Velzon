...
<!-- Mirrored from themesbrand.com/velzon/html/master/apps-ecommerce-seller-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 12 Aug 2024 07:46:22 GMT -->
<head>

    <meta charset="utf-8" />
    <title>Seller Details | Velzon - Admin & Dashboard Template</title>
                        ...
                        <div class="col-xxl-9">
                            <div class="card">
                                ...
                                <div class="card-body p-0 pb-2">
                                    <div>
                                        <div id="customer_impression_charts" data-colors='["--vz-primary", "--vz-success", "--vz-danger"]' data-colors-minimal='["--vz-primary-rgb, 0.1", "--vz-primary", "--vz-primary-rgb, 0.6"]' data-colors-saas='["--vz-success", "--vz-primary", "--vz-danger"]' data-colors-creative='["--vz-warning", "--vz-secondary", "--vz-success"]' class="apex-charts"></div>
                                    </div>
                                </div><!-- end card body -->
                            </div><!-- end card -->
...
<!-- Mirrored from themesbrand.com/velzon/html/master/apps-ecommerce-seller-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 12 Aug 2024 07:46:23 GMT -->
</html>